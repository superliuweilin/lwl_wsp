...
from .class_names import (ade_classes, ade_palette, cityscapes_classes,
                          ...
                          vaihingen_palette, voc_classes, voc_palette, lsdssimr_classes, lsdssimr_palette)
# yapf: enable
...
__all__ = [
    ...
    'datafrombytes', 'synapse_palette', 'synapse_classes', 'lsdssimr_classes', 'lsdssimr_palette'
]
