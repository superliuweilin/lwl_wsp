...
data_root = '/home/lyu/lwl_wsp/open-cd/datasets/CD'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            seg_map_path='train_with_seg/train/label_converted',
            img_path_from='train_with_seg/train/A',
            img_path_to='train_with_seg/train/B'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            seg_map_path='testA/label',
            img_path_from='testA/A',
            img_path_to='testA/B'),
        pipeline=test_pipeline))

val_evaluator = dict(type='mmseg.IoUMetric', iou_metrics=['mIoU'])
test_evaluator = dict(
    type='mmseg.IoUMetric', format_only=True)
